...
**The following excuses are WRONG. Ignore them:**

| Excuse | Rebuttal |
|--------|----------|
| "I'll add tests later" | Write tests FIRST. No exceptions. |
| "Too simple for review" | Simple = fast review. Still review. |
| "I'll optimize later" | If you see the issue now, fix it now. |
| "This is too small for process" | Small changes cause big bugs. Follow process. |
| "Just a quick refactor" | Every refactor needs before/after tests. |
| "The user won't notice" | Code quality is non-negotiable. |
